...
<script type="text/javascript">
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (data.success){
                        //修改备注成功,后台返回数据更新相应备注的内容(noteContext.editTime.editBy)
	...
	function showRemarkList() {
		$.ajax({
			...
			success:function (data) {
				...
				html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
				html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #BF4C53;"></span></a>';
				html += '&nbsp;&nbsp;&nbsp;&nbsp;';
				html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #BF4C53;"></span></a>';
				html += '</div>';
				html += '</div>';
				html += '</div>';
    ...
    function editRemark(id) {
        ...
        //打开模态窗口之前找到存放备注信息的h5标签
        var noteContent = $("#e"+id).html();
        //将h5中展现出来的信息.赋予到修改操作的文本域中
        $("#noteContent").val(noteContent);
      //  以上信息处理完毕,将修改备注的模态号窗口打开
