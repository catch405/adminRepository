...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function () {
		...
		$(".time1").datetimepicker({
			...
			autoclose: true,
			todayBtn: true,
			pickerPosition: "bottom-left"/*向下显示*/
		});
		$(".time2").datetimepicker({
			...
			autoclose: true,
			todayBtn: true,
			pickerPosition: "top-left"/*向下显示*/
		});


		//为市场活动源放大镜图标绑定事件,打开搜索市场活动的模态窗口
		$("#openSearchModalBtn").click(function () {
			$("#findMarketActivity").modal("show");
		});


		//为搜索市场活动的模态窗口中的搜索框绑定事件,执行市场活动搜索和展现操作
		...
		//为搜索联系的模态窗口中的提交按钮绑定事件,填充(填写两项信息,id和name)
		...
		//为阶段的下拉框绑定选中下拉框的事件,根据选中的阶段填写可能性的值
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="aname" style="width: 300px;" placeholder="请输入市场活动名称，按回车键搜索">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="cName" style="width: 300px;" placeholder="请输入联系人名称，按回车键搜索">
						    <span class="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
	...
	<form  action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);"  id="openSearchModalBtn" ><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
